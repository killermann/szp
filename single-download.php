...
<?php $download_id = get_the_ID();?>
	...
	<div id="content" class="clearfix <?php $category = get_the_category(); echo $category[0]->slug;?>">
					...
					<article id="post-<?php the_ID(); ?>" <?php post_class(''); ?> role="article">
						...
						<section>
							<div class="course-info type-wrap">
								...
								<p>Our courses are made up of a collection of <strong>lessons</strong>, and different <strong>topics</strong> within those lessons. We use <strong>worksheets</strong> and <strong>quizzes</strong> to complement your learning. For some courses, we offer a printable (rainbow-gorgeous) <strong>certificate</strong> of completion.</p>
						...
						<section class="course-info" id="Sign-Up">
							...
							<p>Our courses, like the rest of our resources, are offered in the spirit of the gift economy. What this means is you decide what to pay for this course. Our goal is to remove financial barriers, while inviting you to financially support our tiny team (Meg & Sam) and the course ecosystem.</p>
							<p><strong>We trust you to select the option that is right for you, based on your ability to pay, gratitude, or sense of what is fair.</strong></p>
							<p>
								<a class="biglink" href="#Group-Tuition-Options">
									Jump to Group Tuition <i class="far fa-arrow-down"></i>
								</a>
							</p>
							<h3 id="Individual-Tuition-Options">Individual Tuition Options</h3>
							<div class="individual-options">
								<div class="individual-options--prices"><?php echo do_shortcode('[purchase_link id="' . $download_id . '" text="Enroll Now" direct="true" style="button blue"]')?></div>

								<div class="card explainer">
									<h4><i class="far fa-lg fa-question"></i> Need help choosing which is right for you?</h4>
									<p>We know that "gift economy" is isn't the usual way of doing things. If you're struggling with choosing a tuition option that is right for you, you can consider the following:</p>
									<ul>
										<li>
											<strong>Choose Tuition + Fund Scholarship if</strong> you want to provide a gift for someone who cannot afford the tuition, or the standard tuition seems lower than what you can afford for this course.
										</li>
										<li>
											<strong>Choose Standard Tuition if</strong> you want to (and can) financially contribute to support the course resources, server costs, and facilitators’ time.
										</li>
										<li>
											<strong>Choose Full Scholarship if</strong> you want/need to receive this course as a gift from Meg &amp; Sam, and those who have funded scholarships.
										</li>
									</ul>
									<p class="footnote"><i class="far fa-smile-beam"></i> And hey &mdash; regardless of your choice, at the end of the course you'll be invited to gift any amount, or request a refund.</p>
								</div>
								<div>
							...
							<h3 id="Group-Tuition-Options">Group, Organization, & Institutional Tuition Options</h3>
		...
		<section class="pad type-wrap">
			...
			<?php echo do_shortcode('[purchase_link id="' . $download_id . '" text="Enroll Now" direct="true" style="button blue"]')?>
